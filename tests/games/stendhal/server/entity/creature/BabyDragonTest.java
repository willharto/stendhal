...
public class BabyDragonTest {
	...
	{	final int wantedweight = 1; 
		final StendhalRPZone zone = new StendhalRPZone("zone");
		final Player roger = PlayerTestHelper.createPlayer("roger");
		zone.add(roger);
		final BabyDragon weightdragon = new BabyDragon(roger);
		
		assertThat(weightdragon.getWeight(), is(wantedweight));
	}
